 ...
 * 
 */
public enum StreetPostTypeEnum {
	...
	private StreetPostTypeEnum(String inName, String inStandardAbbreviation, Set<String> inCommonAbbreviations) {
		this.name = inName;
	...
	public static StreetPostTypeEnum fromCommonAbbreviation(String inCommonAbbreviation) {
		if (inCommonAbbreviation == null) {
			return null;
		}
		
		for (StreetPostTypeEnum currStreetSuffix : StreetPostTypeEnum.values()) {
